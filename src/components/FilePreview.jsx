        ...
        default:
            ...
            return (
                <div className="max-w-[340px] text-white">
                    {
                        !message.is_deleted && (
                            <div className="bg-[var(--bg-primary)] text-[var(--text-primary)]  rounded-2xl p-3 flex items-center md:gap-8 gap-2 shadow-md sm:flex-row flex-col">
                                {/* File Info */}
                                <div className="flex-1 min-w-0 flex items-center gap-2">
                                    <div className="w-10 h-10 rounded-lg bg-[var(--bg-secondary)]  flex items-center justify-center shrink-0 md:block hidden">
                                        <FileText size={20} className="text-gray-300 m-auto my-2" />
                                    </div>

                                    <div className="min-w-0">
                                        <p className="text-xs text-[var(--text-secondary)]">{message?.file_name?.split(".")[1]} • {(message?.file_size / 1024 / 1024).toFixed(2)} MB</p>
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        className="w-8 h-8 rounded-full flex items-center justify-center bg-[var(--bg-secondary)]  hover:bg-[var(--bg-primary)]  transition cursor-pointer relative z-10">
                                        <Download size={16} />
                                    </div>
                                </button>
                            </div>
